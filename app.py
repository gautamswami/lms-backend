...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://172.16.1.13:3000", "http://localhost", "http://localhost:3000", "http://172.16.1.219:8800"],
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=8800, ssl_keyfile='Cert/nginx.key', ssl_certfile='Cert/nginx.crt')
