...
def get_team_members(counselor_id: int, db: Session = Depends(get_db), current_user: User = Depends(
    ...
    for member in team_members:
        ...
        team_member_details.append(UserTeamView(
            ...
            hours_of_non_technical_traning_completed=non_technical_hours,
            hours_of_technical_traning_completed=technical_hours,
            hours_of_technical_traning_target=50,
            hours_of_non_technical_traning_target=15,
